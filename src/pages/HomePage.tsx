        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              Experience the best in rice delivery service
            </p>
          </div>
      ...
      <section className="py-12 bg-gradient-to-r from-orange-500 to-amber-500">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-white text-lg mb-8 opacity-90">
            Get expert assistance in choosing the right rice variety and pricing
            for your wholesale or retail needs.
          </p>
          <a
            href="https://wa.me/+919550607240?text=Hi! I'm interested in buying rice for my business. Please assist."
            target="_blank"
